...
root = Tk()
canvas = Canvas( width=500, height=550)  # инициализация холста 500х500
canvas.pack()  # размещаем холст в нашем окне
canvas.create_oval(10, 10, 490, 490, fill="lightblue")  # циферблат  просто круг
canvas.create_text(250, 350, text='Зроблено на Python', font=('Arial', 10))  # вывод текста "Зроблено на Python"
canvas.create_text(250, 225, text='.',
                   font=("Arial", 62))  # выводим точку - центр циферблата, чтобы было куда стрелки крепить
i = 0  # счетчик цикла
